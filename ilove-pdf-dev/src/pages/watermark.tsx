  ...
  return (
    <div className="w-full h-screen bg-[#0d0d12] flex overflow-hidden">
      <div className="flex-1 flex flex-row overflow-hidden">
        ...
        {/* Main Preview Area */}
        <div className="flex flex-1 relative bg-[#08080c] md:flex items-center justify-center p-4 md:p-8 overflow-hidden z-[50]">
...
if (rootElement) {
  ReactDOM.createRoot(rootElement).render(<WatermarkPage />);
}
